...
const postxmltest = (_: NextApiRequest, res: NextApiResponse) => {
  ...
  const url = 'https://postxmltest.blob.core.windows.net/myblobcontainer/myblockblob/myblob.xml?sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2023-11-06T18:52:01Z&st=2023-11-06T10:52:01Z&spr=https&sig=TDGRx4FpPmp%2BWzTwz5iXM1VSnLS0qNiE9QshrkNyVFM%3D'
